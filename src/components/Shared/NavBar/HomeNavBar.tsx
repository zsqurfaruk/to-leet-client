...
useEffect(() => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      if (currentPosition > scrollThreshold) {
        setBackgroundColor("#1490a3d6"); // Change to your desired background color
      } else {
  ...
  return (
    <>
      <div  style={{ background: backgroundColor }} className="sticky top-0 z-10 bg-warning h-max min-w-full rounded-none py-2 px-1 md:px-0 lg:px-8 lg:py-4 border-none text-primary shadow-sm">
