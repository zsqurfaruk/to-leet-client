...
const PostAllDivisionBan = () => {
  const { postDivisionNameBan, setPostDivisionNameBan }: any = useContext(PostStateContext);
  console.log(postDivisionNameBan);
  return (
        ...
        <li>
          <label className="flex gap-2">
            <input
              ...
              onClick={(e: any) => setPostDivisionNameBan(e.target.name)}
              name="ঢাকা"
            />
...
export default PostAllDivisionBan;
