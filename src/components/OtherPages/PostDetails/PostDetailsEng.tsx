...
//   rentType: string;
// };
// const PostDetailsEng = ({ districtLocation, rentType }: any) => {
...
//                 City :
//                 {postCityNameEng && postCityNameEng === "Barisal" && lang && (
//                   <span>Barishal</span>
//                 )}
//               </span>
...
//             )} */}
//               {lang ? (
//                 <span> Area: {popularAreaNameForPost}</span>
//               ) : (
//                 <span> এলাকা: {getPopularAreaName}</span>
//               )}
//               <TypeCondition></TypeCondition>
//             </h2>
//             {lang ? <h1>{modalValue?.nameEng} For Rent</h1> : <h1>ধরনঃ {modalValue?.nameBan}</h1>}
//           </div>
