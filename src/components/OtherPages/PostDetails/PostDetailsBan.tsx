...
//   rentType: string;
// };
// const PostDetailsBan = ({ districtLocation, rentType }: any) => {
...
//             <span className="font-semibold">City : 
//             { postCityNameEng === "Barisal" && !lang && <span>বরিশাল</span>
//             } 
