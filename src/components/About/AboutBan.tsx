...
const AboutBan = () => {
  ...
  return (
    <div className="w-10/12 mx-auto py-10 text-gray-700">
      ...
      কুইকভাড়া:  দা আলটিমেট রেন্টাল সল্যুশন
      </h1>
      ...
      <span className="text-warning"> কুইকভাড়া </span> - এ স্বাগতম, <span className="text-warning"> কুইকভাড়া </span> হল সবচেয়ে নিরাপদ এবং সহজ অনলাইন বাড়ি, মেস, হোস্টেল, অফিস, গ্যারেজ এবং দোকান ভাড়ার পরিষেবা কোম্পানি যার লক্ষ্য আপনার ভাড়ার অভিজ্ঞতাকে সহজ করা।
      <div className="hidden lg:inline">
        <span className="text-warning"> কুইকভাড়া </span> - এ, আমরা বুঝি যে
        ...
        <div>
          ...
          <div className={open ? "hidden" : "block"}>
            <div className="lg:hidden inline">
              <span className="text-warning"> কুইকভাড়া </span> - এ, আমরা
            ...
            <h1 className={"text-xl text-warning"}>
              ...
              <span className={"text-warning text-xl font-semibold"}> ' কুইকভাড়া ' </span>
            ...
            <br />
            <span className="text-warning"> কুইকভাড়া </span> - এ
            ...
            <br /> <span className="text-warning"> কুইকভাড়া </span>
            ...
            <span className="text-warning"> কুইকভাড়া </span> সম্পত্তির
            মালিকদের পুঙ্খানুপুঙ্খভাবে যাচাই করে এবং নিশ্চিত করে যে সমস্ত তালিকা
            বৈধ এবং সঠিক।
            <br />
            <span className="text-warning"> কুইকভাড়া </span> মানুষ
            ...
            <span className="text-warning"> কুইকভাড়া </span> আপনাকে
