              ...
              {!lang ? (
                <h2 className="flex">
                  ...
                  >
                    ...
                    /> Total Bed:
                  </span> <span className="pl-1">{product?.totalBed?.eng} </span>
                </h2>
              ) : (
                <h2 className="flex">
                  <span
                  ...
                  >
                      ...
                      className={product?.bedrooms?.eng ? "hidden" :
                          "text-warning mt-[2px] w-4 mr-[2px]"}
                    /> মোট বেড:</span> <span className={product?.totalBed?.eng === "Single room" ? "text-[13px] pl-1" : "text-sm pl-1"}>  {product?.totalBed?.ban} </span>
                </h2>
              )}
            </div>
          )}
          ...
          {product?.bathrooms && (
            ...
            >
              ...
              {!lang ? (
                ...
                <h2>
                  <span className="text-[13.5px]">বাথরুম</span>: {product?.bathrooms?.ban}
                </h2>
              )}
            </div>
          )}
          ...
          <div className="flex">
            ...
            {!lang ? (
              <h2>
                ...
                <span className="pl-1">{product?.amount} Taka </span>
              </h2>
            ) : (
              <h2>
                {product?.type?.eng === "Mess-(Male)" ||
