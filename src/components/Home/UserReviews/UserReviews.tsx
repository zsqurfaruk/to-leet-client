...
import image1 from "../../../image/review/review-1.jpg";
import image2 from "../../../image/review/review2.jpg";
import image3 from "../../../image/review/review3.jpg";
import image4 from "../../../image/review/review4.jpg";
...
const Review = () => {
  ...
  return (
    ...
    >
      <h2 className="text-center text-4xl font-semibold py-5 mb-3 text-accent">
      What our clients are saying
      </h2>
      <div className="grid grid-cols-1 lg:grid-cols-4  bg-gray-800 pl-8 pt-8 gap-4 pb-8 pr-8 ">
        {allReview.map((reviews:any) => (
          <SingleReviewCard key={reviews.id} reviews={reviews}></SingleReviewCard>
        ))}
      </div>
    </div>
  );
