          ...
          <div className="card-body h-60">
            ...
            {post?.division?.eng && (
              <div className="flex justify-between">
                <h2><span className="font-semibold">District:</span> {post?.districts?.eng}</h2>
                <h2><span className="font-semibold">Division:</span> {post?.division?.eng}</h2>
              </div>
            )}
            {post?.cityName?.eng && (
              <div className="flex justify-between">
                <h2><span className="font-semibold">Area:</span> {post?.areaName?.eng}</h2>
                <h2><span className="font-semibold">City:</span> {post?.cityName?.eng}</h2>
              </div>
            )}
            {/* {
