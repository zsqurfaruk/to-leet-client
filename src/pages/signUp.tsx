  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="keyword"
          content="QuickVara, To Let, To-Let, to let, to-let, quickvara, Basa Vara, Vara, Rent, rent, house rent | flat rent in dhaka | flat rent | flat rent dhaka | apartment rent | to-let | tolet | real estate "
        />
