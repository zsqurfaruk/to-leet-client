...
const PostDetails = () => {
  ...
  return (
    <>
      <Head>
        <title>QuickVara - Post Details</title>
        ...
        <meta
          property="og:title"
          content="QuickVara - Post Details | toleet | Tolet | Basa Vara | quickvara | house rent | rent"
        />
        <meta property="og:description" content="" />
        <meta property="og:site_name" content="quickvara.com" />
        <meta charSet="utf-8" />
        <link rel="icon" href="/favicon.ico" />
        <meta name="title" content="QuickVara - Post Details | toleet | Property Tolet | Basa Vara | quickvara | house rent | rent" />
        <meta name="keywords" />
        <meta
          name="description"
          content="Find your rental solution with quickvara's extensive listings for rent. QuickVara is the most secure and easy online home, mess, hostel, office, garage, and shop rental service company which aims to simplify your rental experience."
        ...
        <meta
          property="og:title"
          content="QuickVara - Post Details | toleet | Property Tolet | Basa Vara | quickvara | house rent | rent"
        />
        <meta property="og:description" content="" />
        <meta property="og:site_name" content="quickvara.com" />
      </Head>
